...
```{r}
obj$summary(X_test, y=y_test, class_name = "setosa", show_progress=FALSE)
```
...
```{r}
obj$summary(X_test, y=y_test, class_name = "Adelie", show_progress=FALSE)
```
...
```{r}
obj$summary(X_test, y=y_test, class_name = "malignant", show_progress=FALSE)
```
...
```{r}
obj <- learningmachine::Classifier$new(method = "krr", level = 95)
obj$get_type()
obj$get_name()
```
...
```{r}
obj$summary(X_test, y=y_test, class_name = "malignant", 
            show_progress=FALSE)
```
...
```{r}
obj$summary(X_test, y=y_test, class_name = "setosa", 
            show_progress=FALSE)
```
...
```{r}
obj <- learningmachine::Classifier$new(method = "extratrees", level = 90)
obj$get_type()
obj$get_name()
```
...
```{r}
obj$summary(X_test, y=y_test, class_name = "Adelie", 
            show_progress=FALSE)
```
