...
AutoRidgeRegressor <-
  R6::R6Class(
    classname = "AutoRidgeRegressor",
    inherit = learningmachine::BaseRegressor,
    public = list(
      name = "AutoRidgeRegressor",
      type = "regression",
      model = NULL,
      X_train = NULL,
      y_train = NULL,
      ...
      engine = NULL,
      params = NULL,
      initialize = function(name = "AutoRidgeRegressor",
                            type = "regression",
                            model = NULL,
                            X_train = NULL,
                            y_train = NULL,
...
AutoRidgeClassifier <-
  R6::R6Class(
    classname = "AutoRidgeClassifier",
    inherit = learningmachine::BaseClassifier,
    public = list(
      initialize = function(name = "AutoRidgeClassifier",
                            type = "classification",
                            engine = NULL) {
        self$name <- name
        self$type <- type
      ...
      fit = function(X, y, ...) {
        ...
        self$set_engine(
          list(
            fit = fit_ridge_regression,
            predict = function(objs, X)
              predict_ridge_multitaskregression(objs, X)
          )
        )
        return(base::invisible(self))
      },
